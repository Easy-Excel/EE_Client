        ...
        <div>   
            <Title>피벗테이블</Title>
               <Container>
                ...
                <Paragraph>피벗테이블은 데이터를 계산, 요약 및 분석하는 강력한 도구로서 데이터의 비교, 패턴 및 추세를 보는데 사용할 수 있습니다.</Paragraph>
                <SubTitle>사용하는 방법</SubTitle>

                <How>1. 피벗테이블로 확인하고 싶은 데이터 영역을 추가해준 뒤,[삽입] 피벗테이블을 선택합니다.</How>
                <HelpImage src={pivotTableImage}/>

                {/* src={require("../assets/images/polygon.svg").default */}
                <How>2. 피벗테이블로 확인하고 싶은 데이터 영역을 추가해준 뒤,[삽입] 피벗테이블을 선택합니다.</How>
                <Btn>예제</Btn>
            </Container>
